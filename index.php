            ...
            <div class="nav-wrapper">
                <form method="GET" action="search.php">
                    ...
                    <div class="center-align">
                        <button type="submit" name="search" class="blue waves-light miaw waves-effect btn hide">Recherche</button>
                    </div>
                </form>
            </div>
        </nav>
        ...
        <div class="row">
            <div class="col s12 m6">
                <div class="card animated slideInUp wow">
                    <div class="card-image">
                        <img src="src/img/NouvelleCollection.jpg" alt="">
                    </div>
                </div>
            </div>

            <div class="col s12 m6">
                <h3 class="animated slideInUp wow">Nouvelle collection :</h3>
                <div class="divider animated slideInUp wow"></div>
                <p class="animated slideInUp wow">Cette année uniqli a décidé de lancer une nouvelle collection sur la thématique 
                des arts Japonais. Vague de Hokusai,      
                </p>
            </div>
...
<div class="container contact" id="contact">
    <div class="row">
        <form action="https://postmail.invotes.com/send" method="post" id="email_form" class="col s12 animated slideInUp wow">
            <h3 class="animated slideInUp wow">Nous Contacter:</h3>
            <div class="row">
                ...
                <div class="center-align">
                    <button id="submit_form" type="submit" name="contact" value="Send" class="button-rounded btn-large waves-effect waves-light">Envoyer</button>
                </div>
